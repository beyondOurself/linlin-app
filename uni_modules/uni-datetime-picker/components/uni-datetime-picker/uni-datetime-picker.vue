			...
			<slot>
				<view class="uni-date-editor--x" :class="{ 'uni-date-editor--x__disabled': disabled, 'uni-date-x--border': border }">
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						...
						<input class="uni-date__x-input" type="text" v-model="defaultValComputed" :placeholder="singlePlaceholderText" :disabled="true" />
					</view>
					...
					<view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear"><uni-icons type="clear" color="#e1e1e1" size="18"></uni-icons></view>
				</view>
			</slot>
		</view>
...
export default {
	...
	computed: {
		defaultValComputed(){
			...
			return this.singleVal || this.modelValue	
		},
		reactStartTime() {
