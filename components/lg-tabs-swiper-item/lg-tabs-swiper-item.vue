<template>
	<view class="lg-swiper-page_wrap">
		...
		<swiper class="swiper_body" @change="swiperChange" :current="swiperIndex">
			<swiper-item>
				<view class="swiper-block_box"><slot name="home"></slot></view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-block_box"><slot name="interact"></slot></view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-block_box"><slot name="record"></slot></view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-block_box"><slot name="shope"></slot></view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-block_box"><slot name="me"></slot></view>
			</swiper-item>
		</swiper>
	</view>
</template>
...
onMounted(() => {
	...
	query.select('.swiper__sliding-blocks_box').fields({ rect: true, size: true }, ({ left, width }) => {
...
.sliding-block_wrap {
	...
	margin: 0 $lg-sliding-block-marging;
}
.sliding-line_box {
	position: absolute;
	bottom: 0;
